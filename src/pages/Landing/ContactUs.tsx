...
<div className='flex justify-center items-center mb-4'>
  <span className='text-xs md:text-sm px-8 py-1 rounded-full text-[#4DA0D7] bg-sky-100 '>
    Contact Us
  </span>
</div>
...
<div className='flex max-lg:flex-col gap-6'>
  {/* Left: Contact Form */}
  <div className='flex flex-col relative w-full lg:w-1/2 bg-white rounded-xl shadow-md p-6 md:p-8'>
