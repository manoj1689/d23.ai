...
function Header() {
    ...
    return (
        <div className="flex w-full bg-[#202544] pt-12">
            <div className="flex max-lg:flex-col container w-full h-auto mx-auto  px-4">
                ...
                <div className="flex flex-col w-full lg:w-3/5 py-20 lg:pt-24 pb-16 ">
                    ...
                    <section className="flex flex-col sm:flex-row  gap-5 mt-8">
                        ...
                        <button
                            onClick={onOpenModal}
                            className="flex items-center gap-2 px-5 py-3 bg-transparent border border-gray-500 rounded-full shadow-md shadow-sky-800 text-md md:text-lg justify-center  text-transparent bg-clip-text bg-gradient-to-r from-[#63A7D4] to-[#F295BE]"
                        >
                    ...
                    <section className="flex w-full xl:w-3/4 mt-10 text-white text-center">
                        <div className="w-1/3 flex max-lg:flex-col justify-center items-center px-2 lg:gap-3">
                            <div className="text-lg lg:text-2xl font-light">50K+</div>
                            <div className="text-sm font-light">Active Users</div>
                        </div>
                        <div className="w-1/3 flex max-lg:flex-col justify-center items-center px-2 lg:gap-3 border-l-2 border-gray-500 ">
