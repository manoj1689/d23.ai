    ...
    return (
        <div className='flex container mx-auto flex-col items-center text-center py-12 px-4 bg-white'>
            ...
            <div className='flex gap-4 max-md:flex-col '>
                {/* Join Debate */}
                <div className='rounded-xl shadow-md px-6 py-4 bg-gray-50 hover:shadow-xl transition'>
                    <div className='flex items-center mb-4'>
                        <div className='text-yellow-500 text-3xl w-1/3'>
                        <img src="./images/formats/joinDebate.png" alt="start debate" className='w-24 ' /></div>
                        <div className='w-2/3'>
                            <h3 className='text-lg md:text-xl lg:text-3xl text-left text-neutral-800'>Join Debate</h3>
                        </div>
                    </div>
                    <p className='text-sm md:text-md lg:text-lg font-light text-left text-gray-600 mb-4'>
                ...
                <div className='rounded-xl shadow-md px-6 py-4 bg-gray-50 hover:shadow-xl transition'>
                    <div className='flex items-center mb-4'>
                        <div className='w-1/3'> <img src="./images/formats/startDebate.png" alt="start debate" className='w-24' /></div>
                        <div className='w-2/3 '>
                            <h3 className='text-lg md:text-xl lg:text-3xl text-left text-neutral-800'>Start a Debate</h3>
                        </div>
                    </div>
                    <p className='text-sm md:text-md lg:text-lg font-light text-left  text-gray-600 mb-4'>
                ...
                <div className='rounded-xl shadow-md px-6 py-4 bg-gray-50 hover:shadow-xl transition'>
                    <div className='flex items-center mb-4'>
                        <div className='text-green-500 text-3xl w-1/3'> <img src="./images/formats/debateAi.png" alt="start debate" className='w-24' /></div>
                        <div className='w-2/3'>
                            <h3 className='text-lg md:text-xl lg:text-3xl text-left text-neutral-800'>Debate with Ai</h3>
                        </div>
                    </div>
                    <p className='text-sm md:text-md lg:text-lg font-light text-left text-gray-600 mb-4'>
